...
const BackEndMetrics = ({ projectIDState, formatData }) => {
  ...
  const fetchBEMetrics = () => {
    fetch(
      ...
      .then((data) => {
        ...
        const uniquePaths = [
          ...new Set(
            Object.values(data.BEmetrics).map((metric) => metric.path)
          ),
        ];
  ...
  const filteredBE = useMemo(() => {
    if (selectedPath)
      return bEMetrics.filter((metric) => metric.path === selectedPath);
    else return null;
  }, [bEMetrics, selectedPath]);

  const filteredLatest = useMemo(() => {
    if (selectedPath) {
      const filteredData = bEMetrics.filter(
        (metric) => metric.path === selectedPath
      );
                          ...
                          <PieChart>
                            <Pie
                              data={[
                                ...
                                {
                                  name: '',
                                  value: 100 - filteredLatest.performance_score,
                                  fill: '#ffffff',
                                },
                              ]}
                              dataKey='value'
                          ...
                          <PieChart>
                            <Pie
                              data={[
                                ...
                                {
                                  name: '',
                                  value: 100 - filteredLatest.heap_used,
                                  fill: '#ffffff',
                                },
                              ]}
                              dataKey='value'
                    ...
                    <Grid item xs={8} md={4}>
                      ...
                      >
                        ...
                        <div className='metrics-description'>
                          ...
                          <br></br>
                          <b>Payload size:</b> Avg size of the request payloads
                    ...
                    <Grid item xs={8} md={4}>
                      ...
                      >
                        ...
                        <div className='metrics-description'>
                          ...
                          <br></br>
                          <b>Total heap:</b> Total size of the allocated heap
                          <br></br>
                          <b>Heap used:</b> Amount of the heap that is currently
                          being used by JS objects
                          <br></br>
