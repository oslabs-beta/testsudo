        ...
        exec(command, (error, stdout, stderr) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (stdout) {
                ...
                try {
                    ...
                    yield postSecurityDataMongo(projectID, transformedData);
                }
                catch (parseError) {
...
const postSecurityDataMongo = (projectID, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios.post(`${webAppURL}${projectID}`, data);
