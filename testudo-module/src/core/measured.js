...
//         console.log('metrics data is ', metricsData);
//     });
...
//             // Prepare metrics data for sending
//             const metricsData = {
//                 path: req.path,
//                 duration,
//                 requestBodySize,
...
//             axios.post(`http://localhost:3001/projects/BE/${projectID}`, metricsData)
//                 .then(() => console.log('Metrics data sent to the server.'))
...
const handleMeasuredRequestFactory = (projectID) => {
    return (req, res, next) => {
        ...
        res.on('finish', async () => {
            ...
            axios.post(`http://localhost:3001/projects/BE/${projectID}`, metricsData)
                .then(() => console.log('Metrics data and performance score sent to the server.'))
                .catch(err => console.error('Error sending metrics data to the server:', err));
